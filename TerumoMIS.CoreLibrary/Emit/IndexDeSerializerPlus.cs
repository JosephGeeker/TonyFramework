...
//  All rights reserved
//	Input Item: IndexDeSerializerPlus
//	PC Name:    PC0525
//	Name Space: TerumoMIS.CoreLibrary.Emit
//	File Name:  IndexDeSerializerPlus
//	User name:  C1400008
//	Location Time: 2015/7/13 14:25:32
...
namespace TerumoMIS.CoreLibrary.Emit
{
    ...
    /// 二进制数据反序列化
    /// </summary>
    public unsafe sealed class IndexDeSerializerPlus:BinaryDeSerializerPlus
    {
        /// <summary>
        /// 基本类型反序列化函数
        /// </summary>
        ...
        internal static class TypeDeSerializerPlus
        {
            ...
            /// 未知类型反序列化调用函数信息集合
            /// </summary>
            private static interlocked.dictionary<Type, MethodInfo> memberDeSerializers = new interlocked.dictionary<Type,MethodInfo>(dictionary.CreateOnly<Type, MethodInfo>());
            /// <summary>
            /// 未知类型枚举反序列化委托调用函数信息
            /// </summary>
            ...
            /// 未知类型反序列化调用函数信息集合
            /// </summary>
            private static interlocked.dictionary<Type, MethodInfo> memberMapDeSerializers = new interlocked.dictionary<Type,MethodInfo>(dictionary.CreateOnly<Type, MethodInfo>());
            /// <summary>
            /// 未知类型枚举反序列化委托调用函数信息
            /// </summary>
            /// <param name="type">数组类型</param>
        ...
        internal static class TypeDeSerializerPlus<TValueType>
        {
            ...
            internal delegate void DeSerializeDele(indexDeSerializer deSerializer, ref TValueType value);
            /// <summary>
            /// 二进制数据反序列化委托
            /// </summary>
            ...
            /// <param name="deSerializer">二进制数据反序列化</param>
            /// <param name="value">目标数据</param>
            private delegate void MemberMapDeSerializeDele(memberMap memberMap, indexDeSerializer deSerializer, ref TValueType value);
            /// <summary>
            /// 二进制数据序列化类型配置
            /// </summary>
            ...
            internal static void DeSerialize(indexDeSerializer deSerializer, ref TValueType value)
            {
                if (DefaultDeSerializer == null)
                {
                    if (value == null) value = fastCSharp.emit.constructor<TValueType>.New();
            ...
            /// <param name="value">数据对象</param>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            internal static void StructDeSerialize(indexDeSerializer deSerializer, ref TValueType value)
            {
            ...
            /// <param name="deSerializer">二进制数据反序列化</param>
            /// <param name="value">数据对象</param>
            internal static void MemberDeSerialize(indexDeSerializer deSerializer, ref TValueType value)
            {
            ...
            /// <param name="value">数据对象</param>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            internal static void BaseSerialize<childType>(indexDeSerializer deSerializer, ref childType value) where childType : TValueType
            {
            ...
            /// <param name="value">数据对象</param>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            private static void fromNull(indexDeSerializer deSerializer, ref TValueType value)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            private unsafe static void enumByte(indexDeSerializer deSerializer, ref TValueType value)
            {
            ...
            /// <param name="array">枚举值序列化</param>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            private unsafe static void enumSByte(indexDeSerializer deSerializer, ref TValueType value)
            {
            ...
            /// <param name="array">枚举值序列化</param>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            private unsafe static void enumShort(indexDeSerializer deSerializer, ref TValueType value)
            {
            ...
            /// <param name="array">枚举值序列化</param>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            private unsafe static void enumUShort(indexDeSerializer deSerializer, ref TValueType value)
            {
            ...
            /// <param name="array">枚举值序列化</param>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            private unsafe static void enumInt(indexDeSerializer deSerializer, ref TValueType value)
            {
            ...
            /// <param name="array">枚举值序列化</param>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            private unsafe static void enumUInt(indexDeSerializer deSerializer, ref TValueType value)
            {
            ...
            /// <param name="array">枚举值序列化</param>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            private unsafe static void enumLong(indexDeSerializer deSerializer, ref TValueType value)
            {
            ...
            /// <param name="array">枚举值序列化</param>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            private unsafe static void enumULong(indexDeSerializer deSerializer, ref TValueType value)
            {
            ...
            static TypeDeSerializerPlus()
            {
                ...
                if (constructor<TValueType>.New == null) DefaultDeSerializer = fromNull;
                else
                {
                    ...
                    binarySerializer.fields<indexSerializer.fieldInfo> fields = indexSerializer.typeSerializer.GetFields(memberIndexGroup<TValueType>.GetFields(attribute.MemberFilter), out memberCountVerify, out memberMapFixedSize);
                    fixedFillSize = -fields.FixedSize & 3;
                    fixedSize = (fields.FixedSize + (sizeof(int) + 3)) & (int.MaxValue - 3);
                    TypeDeSerializerPlus.MemberDynamicMethodStruct fixedDynamicMethod = new TypeDeSerializerPlus.MemberDynamicMethodStruct(type);
                    TypeDeSerializerPlus.MemberMapDynamicMethodStruct fixedMemberMapDynamicMethod = new TypeDeSerializerPlus.MemberMapDynamicMethodStruct(type);
                    ...
                    fixedMemberMapDeSerializer = (MemberMapDeSerializeDele)fixedMemberMapDynamicMethod.Create<MemberMapDeSerializeDele>();

                    TypeDeSerializerPlus.MemberDynamicMethodStruct dynamicMethod = new TypeDeSerializerPlus.MemberDynamicMethodStruct(type);
                    TypeDeSerializerPlus.MemberMapDynamicMethodStruct memberMapDynamicMethod = new TypeDeSerializerPlus.MemberMapDynamicMethodStruct(type);
                    ...
                    memberMapDeSerializer = (MemberMapDeSerializeDele)memberMapDynamicMethod.Create<MemberMapDeSerializeDele>();
        ...
        private deSerializeState deSerialize<valueType>(byte* start, byte* end, ref valueType value, config config)
        {
            ...
            TypeDeSerializerPlus<valueType>.DeSerialize(this, ref value);
            checkState();
        ...
        {
            TypeDeSerializerPlus<valueType>.BaseSerialize(deSerializer, ref value);
        }
        /// <summary>
        /// 基类反序列化函数信息
        /// </summary>
        ...
        private void structArrayType<valueType>(ref valueType[] array)
        {
            ...
            if (length != 0)
            {
                if ((length + 1) * sizeof(int) <= (int)(end - Read))
                {
                    ...
                    {
                        TypeDeSerializerPlus<valueType>.StructDeSerialize(this, ref array[index]);
                        if (state != deSerializeState.Success) return;
                    }
                }
                else Error(deSerializeState.IndexOutOfRange);
                ...
                if (mapLength <= (int)(end - Read))
                {
                    ...
                    for (int index = 0; index != array.Length; ++index)
                    {
                        ...
                        else
                        {
                            ...
                            TypeDeSerializerPlus<valueType>.StructDeSerialize(this, ref value);
                            if (state != deSerializeState.Success) return;
                            array[index] = value;
                        }
                    }
            ...
            if (length != 0)
            {
                ...
                if (mapLength <= (int)(end - Read))
                {
                    ...
                    for (int index = 0; index != array.Length; ++index)
                    {
                        ...
                        {
                            TypeDeSerializerPlus<valueType>.DeSerialize(this, ref array[index]);
                            if (state != deSerializeState.Success) return;
                        }
                    }
                }
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static valueType DeSerialize<valueType>(subArray<byte> data, config config = null)
        {
            if (data.Count != 0)
            {
                fixed (byte* dataFixed = data.array) return DeSerialize<valueType>(dataFixed + data.StartIndex, data.Count, config);
            }
            if (config != null) config.State = deSerializeState.UnknownData;
            return default(valueType);
        }
        ...
        public static valueType DeSerialize<valueType>(unmanagedStream data, int startIndex = 0, config config = null)
        {
            ...
            {
                return DeSerialize<valueType>(data.Data + startIndex, data.Length - startIndex, config);
            }
            if (config != null) config.State = deSerializeState.UnknownData;
            return default(valueType);
        }
        ...
        public static bool DeSerialize<valueType>(subArray<byte> data, ref valueType value, config config = null)
        {
            if (data.Count != 0)
            {
                fixed (byte* dataFixed = data.array) return DeSerialize<valueType>(dataFixed + data.StartIndex, data.Count, ref value, config);
            }
            if (config != null) config.State = deSerializeState.UnknownData;
            return false;
        }
        ...
        public static bool DeSerialize<valueType>(unmanagedStream data, ref valueType value, int startIndex = 0, config config = null)
        {
            if (data != null && startIndex >= 0)
            {
                return DeSerialize<valueType>(data.Data + startIndex, data.Length - startIndex, ref value, config);
            }
            if (config != null) config.State = deSerializeState.UnknownData;
            return false;
        }
        ...
        static indexDeSerializer()
        {
            ...
            foreach (MethodInfo method in typeof(indexDeSerializer).GetMethods(BindingFlags.Instance | BindingFlags.NonPublic))
            {
                ...
                if (method.customAttribute<memberDeSerializeMethod>() != null)
                {
                    ...
                    {
                        log.Error.Real(parameterType.fullName());
                    }
                }
