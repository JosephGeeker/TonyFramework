...
//  All rights reserved
//	Input Item: LoadCachePlus
//	PC Name:    PC0525
//	Name Space: TerumoMIS.CoreLibrary.MemoryDataBase.Cache
//	File Name:  LoadCachePlus
//	User name:  C1400008
//	Location Time: 2015/7/16 13:12:37
...
namespace TerumoMIS.CoreLibrary.MemoryDataBase.Cache
{
    /// <summary>
    /// 数据加载基本缓存接口
    /// </summary>
    ...
    public interface ILoadCache<out TValueType, TModelType> : IDisposable
        ...
        where TModelType : class
    {
        ...
        /// </summary>
        /// <returns></returns>
        subArray<TValueType> GetSubArray();
        /// <summary>
        /// 获取数据集合
        /// </summary>
        /// <returns></returns>
        ...
        /// </summary>
        event Action<TValueType, TValueType, memberMap> OnUpdated;
        /// <summary>
        /// 删除对象事件
        /// </summary>
