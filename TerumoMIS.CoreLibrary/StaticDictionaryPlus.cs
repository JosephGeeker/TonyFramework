...
//  All rights reserved
//	Input Item: StaticDictionaryPlus
//	PC Name:    PC0525
//	Name Space: TerumoMIS.CoreLibrary
//	File Name:  StaticDictionaryPlus
//	User name:  C1400008
//	Location Time: 2015/7/17 14:14:41
...
namespace TerumoMIS.CoreLibrary
{
    ...
    public class StaticDictionaryPlus<keyType,valueType>:StaticHashPlus<KeyValueStruct<keyType,valueType>>
        where keyType:IEquatable<keyType>
    {
        ...
        public unsafe staticDictionary(keyValue<keyType, valueType>[] values)
        {
            if (values.length() != 0)
            {
                ...
                pointer data = pool.Get(values.Length * sizeof(int));
                try
                {
