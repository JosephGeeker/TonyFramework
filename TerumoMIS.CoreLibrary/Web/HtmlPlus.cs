...
";
        ...
        public interface IEncoder
        {
            ...
            /// <param name="value">文本值</param>
            /// <returns>HTML编码</returns>
            subString ToHtml(subString value);
            /// <summary>
            /// 文本转HTML
            /// </summary>
            /// <param name="value">文本值</param>
            /// <param name="stream">HTML编码流</param>
            void ToHtml(subString value, unmanagedStream stream);
        }
        /// <summary>
        /// HTML编码器
        /// </summary>
        internal unsafe struct encoder : IEncoder
        {
            ...
            /// <param name="value">文本值</param>
            /// <returns>HTML编码</returns>
            public unsafe subString ToHtml(subString value)
            {
                if (value.Length != 0)
                {
                    int length = value.Length;
                    fixed (char* valueFixed = value.value)
                    {
                        ...
                        if (count != 0)
                        {
                            ...
                            return subString.Unsafe(newValue, 0, newValue.Length);
                        }
                    }
                }
                return value;
            ...
            /// <param name="value">文本值</param>
            /// <param name="stream">HTML编码流</param>
            public unsafe void ToHtml(subString value, unmanagedStream stream)
            {
                if (value.Length != 0)
                {
