...
//	File Name:  SqlPlus
//	User name:  C1400008
//	Location Time: 2015/7/16 12:04:53
...
namespace TerumoMIS.CoreLibrary.Config
{
    ...
    /// SQL相关参数
    /// </summary>
    public sealed class SqlPlus:DataBasePlus
    {
        /// <summary>
        /// 检测链接类型集合
        /// </summary>
        ...
        {
            pub.LoadConfig(this);
            if (checkConnection.length() != 0) fastCSharp.log.Default.Add("数据库链接处理类型: " + checkConnection.joinString(',', value => value.ToString()), false, false);
        }
        /// <summary>
        /// 默认SQL相关参数
        /// </summary>
