        ...
        public abstract class InstancePlus : MemberFilterPlus
        {
            ...
            internal BindingFlags FieldBindingFlags
            {
                get
                {
                    ...
                    if ((Filter & MemberFiltersEnum.PublicInstanceField) == MemberFiltersEnum.PublicInstanceField) flags |= BindingFlags.Public;
                    if ((Filter & MemberFiltersEnum.NonPublicInstanceField) == MemberFiltersEnum.NonPublicInstanceField) flags |= BindingFlags.NonPublic;
            ...
            internal BindingFlags PropertyBindingFlags
            {
                ...
                {
                    BindingFlags flags = BindingFlags.Default;
                    if ((Filter & MemberFiltersEnum.PublicInstanceProperty) == MemberFiltersEnum.PublicInstanceProperty) flags |= BindingFlags.Public;
                    if ((Filter & MemberFiltersEnum.NonPublicInstanceProperty) == MemberFiltersEnum.NonPublicInstanceProperty) flags |= BindingFlags.NonPublic;
                    return flags == BindingFlags.Default ? flags : (flags | BindingFlags.Instance);
                }
            }
        }
