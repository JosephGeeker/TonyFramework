...
//	File Name:  DatePlus
//	User name:  C1400008
//	Location Time: 2015/7/10 16:29:58
...
namespace TerumoMIS.CoreLibrary
{
    ...
    /// 日期相关操作
    /// </summary>
    public unsafe static class DatePlus
    {
        /// <summary>
        /// 每毫秒计时周期数
        /// </summary>
        ...
        /// 32位除以60转乘法的乘数
        /// </summary>
        public const ulong Div6032Mul = ((1L << Div6032Shift) + 59) / 60;
        /// <summary>
        /// 32位除以60转乘法的位移
        /// </summary>
        public const int Div6032Shift = 21 + 32;
        /// <summary>
        /// 16位除以60转乘法的乘数
        /// </summary>
        public const uint Div6016Mul = ((1U << Div6016Shift) + 59) / 60;
        /// <summary>
        /// 16位除以60转乘法的位移
        /// </summary>
        public const int Div6016Shift = 21;
        /// <summary>
        /// 时间转换成字符串(精确到秒)
        /// </summary>
        ...
        {
            var timeString = StringPlus.FastAllocateString(19);
        ...
        private static void ToString(DateTime time, long dayTiks, char* chars)
        {
            ...
            data0 -= data1 * 10;
            var data2 = (data1 * (int)number.Div10_16Mul) >> number.Div10_16Shift;
            data1 -= data2 * 10;
            var data3 = (data2 * (int)number.Div10_16Mul) >> number.Div10_16Shift;
            data2 -= data3 * 10;
            data0 += '0';
            data1 += '0';
            data0 <<= 16;
            ...
            *(int*)(chars + 8) = (data1 += data0);
            ...
            data2 = (int)(((ulong)data3 * Div6032Mul) >> Div6032Shift);
            data3 -= data2 * 60;
            data0 = (data2 * (int)Div6016Mul) >> Div6016Shift;
            data2 -= data0 * 60;
        ...
        private static void ToSqlMillisecond(DateTime time, char* chars)
        {
            ...
            chars[19] = '.';
            var data0 = (int)(((ulong)(dayTiks % (1000 * 10000)) * number.Div10000Mul) >> number.Div10000Shift);
            var data1 = (data0 * (int)number.Div10_16Mul) >> number.Div10_16Shift;
            data0 -= data1 * 10;
            var data2 = (data1 * (int)number.Div10_16Mul) >> number.Div10_16Shift;
            data1 -= data2 * 10;
            data0 += '0';
        ...
        /// 星期
        /// </summary>
        private static readonly PointerStruct WeekData;
        /// <summary>
        /// 月份
        /// </summary>
        private static readonly PointerStruct MonthData;
        /// <summary>
        /// 时间转字节流长度
        /// </summary>
        ...
        /// 时间字节流缓冲区
        /// </summary>
        internal static readonly MemoryPoolPlus ByteBuffers = MemoryPoolPlus.GetPool(ToByteLength);
        /// <summary>
        /// 时间转字节流
        /// </summary>
        ...
        internal unsafe static void ToBytes(DateTime date, byte* data)
        {
            ...
            *(int*)(data + sizeof(int) * 3) = (value1000 + ((value100 - value1000 * 10) << 8) + ((value10 - value100 * 10) << 16) + ((value - value10 * 10) << 24)) | 0x30303030;
            ...
            value1000 = (int)(((ulong)value100 * Div6032Mul) >> Div6032Shift);
            value100 -= value1000 * 60;
            value = (value1000 * (int)Div6016Mul) >> Div6016Shift;
            value1000 -= value * 60;
        ...
        internal static byte[] CopyBytes(byte[] dateTime)
        {
            ...
            fixed (byte* dataFixed = data) MemoryUnsafe.Copy(dateTime, dataFixed, dateTime.Length);
            return data;
        }
        /// <summary>
        /// 精确到秒的时间
        /// </summary>
        private static class NowTimePlus
        {
            /// <summary>
            /// 精确到秒的时间
            /// </summary>
        ...
        public static DateTime Now
        {
            get { return NowTimePlus.Now = DateTime.Now; }
        }
        /// <summary>
        /// 时间更新间隔
        /// </summary>
        ...
        {
            get { return (int)NowTimePlus.Timer.Interval; }
        }
        static DatePlus()
        {
            var dataIndex = 0;
            var datas = UnmanagedPlus.Get(false, 7 * sizeof(int), 12 * sizeof(int));
