...
//  All rights reserved
//	Input Item: StringUnsafer
//	PC Name:    PC0525
//	Name Space: TerumoMIS.CoreLibrary.Unsafe
//	File Name:  StringUnsafer
//	User name:  C1400008
//	Location Time: 2015/7/10 15:17:10
...
namespace TerumoMIS.CoreLibrary.Unsafe
{
    ...
    public static class StringUnsafe
    {
        ...
        {
            fixed (char* sourceFixed = source) MemoryUnsafe.Copy(sourceFixed, destination, source.Length << 1);
        }
        ...
        public static unsafe void Copy(string source, string destination, int destinationIndex)
        {
            ...
            {
                MemoryUnsafe.Copy((void*) sourceFixed, destinationFixed + destinationIndex, source.Length << 1);
            }
        }
            ...
            int count)
        {
            fixed (char* sourceFixed = source, destinationFixed = destination)
            {
                MemoryUnsafe.Copy((void*) (sourceFixed + sourceIndex), destinationFixed + destinationIndex, count << 1);
            }
        }
        ...
        /// <returns>字符位置,失败为null</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe char* Find(char* start, char* end, StringPlus.AsciiMapStruct valueMap, char value)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe int AsciiCount(char* start, char* end, StringPlus.AsciiMapStruct valueMap, char value)
        {
        ...
        /// <returns>字符位置,失败为null</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe char* FindNot(char* start, char* end, StringPlus.AsciiMapStruct valueMap)
        {
        ...
        /// <returns>字符位置,失败为null</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe char* FindLastNot(char* start, char* end, StringPlus.AsciiMapStruct valueMap)
        {
        ...
        /// <param name="valueMap">字符集合</param>
        /// <returns>字符位置,失败为null</returns>
        public static unsafe char* FindLastNotAscii(char* start, char* end, byte* valueMap)
        {
        ...
        public static unsafe byte[] Serialize(string value)
        {
            fixed (char* valueFixed = value)
            {
                ...
                {
                    if ((*start & 0xff00) != 0) return MemoryUnsafe.Copy(valueFixed, value.Length << 1);
                }
            ...
            fixed (char* valueFixed = value)
            {
                for (char* start = valueFixed, end = valueFixed + value.Length; start != end; ++start)
                {
                    if ((*start & 0xff00) != 0)
                    {
                        ...
                        MemoryUnsafe.Copy(valueFixed, write, value.Length << 1);
                        return length;
                    }
                }
