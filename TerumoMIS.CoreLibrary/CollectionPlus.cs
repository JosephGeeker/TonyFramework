...
//  All rights reserved
//	Input Item: CollectionPlus
//	PC Name:    PC0525
//	Name Space: TerumoMIS.CoreLibrary
//	File Name:  CollectionPlus
//	User name:  C1400008
//	Location Time: 2015/7/16 16:40:08
...
namespace TerumoMIS.CoreLibrary
{
    ...
    public sealed class CollectionPlus<valueType>:DynamicArrayPlus<valueType>,IList<valueType>
    {
        /// <summary>
        ...
        /// <param name="values">数据数组</param>
        /// <param name="isUnsafe">true表示可以使用原数组,false表示需要复制数组</param>
        public collection(subArray<valueType> values, bool isUnsafe = false)
        {
            if (isUnsafe)
            {
                if (values.Count != 0)
            ...
            else if (values.Count == 0) array = nullValue<valueType>.Array;
            else
            {
    ...
    public static class collection
    {
        ...
        /// <param name="values">数据集合</param>
        /// <returns>双向动态数组</returns>
        public static collection<valueType> add<valueType>(this collection<valueType> collection, subArray<valueType> values)
        {
            if (collection != null)
            {
            ...
            return new collection<valueType>(values.Array, values.StartIndex, values.Count, false);
        }
        /// <summary>
        /// 添加数据集合
        /// </summary>
